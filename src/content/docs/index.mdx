...
Ce wiki est un recueil de notes personnelles dont certaines dates de mes débuts. La véracité et l’exactitude de ce que vous allez trouver ici n’est donc absolument pas garanti.
...
<CardGrid stagger>
    ...
    <LinkCard
        title="Figurines"
        href="/figurines/"
        description="Peinture sur figurines" />
    <LinkCard
        title="Cuisine"
        href="/cuisine/"
